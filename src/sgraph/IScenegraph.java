...
public interface IScenegraph<VertexType extends IVertexData>
{
    ...
    /**
     * Sets the animation transform to as to explode the given object.
     * @param time
     */
    ...
    public ArrayList<Light> getLights(INode root, Stack<Matrix4f> modelView);
    ...
    /**
     * updates the scenegraph to the exploded view of it
     * @param SG_soFar
     */
